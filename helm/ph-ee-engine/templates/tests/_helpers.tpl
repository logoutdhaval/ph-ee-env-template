...
{{- define "inttest.env" -}}
  env:
    ...
    - name: "PAYBILL_MPESA_CONNECTOR_CONTACTPOINT"
      value: ""
    - name: "VOUCHER-MANAGEMENT_CONTACTPOINT"
    ...
    - name: "GLOBAL_WAIT_TIME_MS"
      value: "5000"
    - name: "ML-CONNECTOR_HOST"
      value: "http://ph-ee-connector-mojaloop-java:8080"
    - name: "ML-CONNECTOR_CONTACTPOINT"
      value: "http://ph-ee-connector-mojaloop-java:8080"
{{- end }}
